    ...
    public void wait5Seconds() {
        ...
        try{
            ...
            new WebDriverWait(driver, 1).
                    ...
                    withMessage("A timeout happened as expected").until(
            ...
            fail("a timeout exception should have been thrown");
              ...
              assertTrue(e.getMessage().contains("A timeout happened as expected"));
        }

        long newCurrentTime = System.currentTimeMillis();

        assertTrue((newCurrentTime - oldCurrentTime) > 5000); // more than 5 secs
    }
